...
import { Switch, Checkbox, Row, Col } from 'antd/lib/';
import { Select, Button, Icon } from 'antd/lib/';
          ...
          <Content style={{minWidth: "350px"}}>
            ...
            <Row style={{width: '100%', background: '#FC5638', color: 'white', maxHeight: "64px"}}>
              ...
              <Col span={24} style={{display: 'flex', alignItems: 'strech'}}>
                ...
                <Icon
                  style={{width: '50px', minWidth: "50px", cursor: 'pointer', background: '#f33434', display: 'flex', justifyContent: 'center', alignItems: 'center'}}
